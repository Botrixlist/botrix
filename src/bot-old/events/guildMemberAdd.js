...
module.exports = (client, member) => {
    ...
    if(member.guild.id == config.GUILD_ID){
        if(member.user.bot){
            ...
            .setDescription(`Botrix is the easiest way to list, advertise and grow your discord server and/or bot on discord!\n\n[List your bot](https://botrix.cc/add) | [Browse our selection](https://botrix.cc/discover)\n\nWe hope you enjoy your stay!`)
        ...
        let channelID = "747393837877428346";
        ...
        const Embed = new discord.MessageEmbed()
            ...
            .setDescription(`Welcome to the server, we hope you enjoy your stay.\n\n` + 'We now have ' + serverCount + ' members in our guild.\n\nIf you have any questions, please reach out in any of our related channels.')
